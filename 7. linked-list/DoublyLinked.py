...
linkedDeque._insert_first("Deep")
linkedDeque._insert_last("Monika")
linkedDeque._insert_first("Kavya")
linkedDeque._insert_last("Garima")
print(linkedDeque.first())
print(linkedDeque.last())
linkedDeque.delete_first()
print(linkedDeque.first())
print(linkedDeque.last())
print(len(linkedDeque))
